...
} from '../../core/google-firebase'    
import { CollectibleAssetType, MediaFolderName, 
    UsageValueType, VoiceNameType } from '../../types'
import {
...
import { checkBotAccess, useUserAccess } from '../auth/utils'
import {
...
const media = {
    ...
    async handleGetWatermarkedGif(req: Request, res: Response) {
        ...
        try {
            ...
            const gif = await gifProcessing.watermarkGif(gifBuffer)
...
const content = {
    ...
    async handleCreateStory(req: Request, res: Response) {
        ...
        const id = generateID(24),
            ...
            share_count = 0,
            like_count = 0,
            min_reading_time = estimateMinReadingTime(all_text.length)
